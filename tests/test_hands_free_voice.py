...
def test_hey_ion_wake_phrase_detection():
    ...
    assert detector.is_wake_word_detected("hey ion")
    assert not detector.is_wake_word_detected("ion")
    assert not detector.is_wake_word_detected("ion battery")
    assert not detector.is_wake_word_detected("ion engine")
    assert not detector.is_wake_word_detected("hey everyone")
